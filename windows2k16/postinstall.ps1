...
Start-Process "VBoxCertUtil.exe" "add-trusted-publisher vbox-sha256.cer --root vbox-sha256.cer" -WorkingDirectory "$cddrive\cert"
Start-Process "$cddrive\VBoxWindowsAdditions.exe" "/S /force" -NoNewWindow -Wait -Verb RunAs
